...
# Called Strike Rate on pitches out of the zone
# Called ball rate on pitches in the zone

# Up to 3-5 inches probably??


pitch_data2 <- pitch_data %>%
    mutate(away_top = pitchData.strikeZoneTop - pitchData.coordinates.pZ,
           away_bottom = pitchData.strikeZoneBottom - pitchData.coordinates.pZ,
           away_left = -.84 - pitchData.coordinates.pX,
           away_right = .84 - pitchData.coordinates.pX)
# pitch_data2 <- pitch_data %>%
